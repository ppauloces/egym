  ...
  <div class="space-y-5">
    ...
    <div class="flex items-center justify-between">
      <div>
        ...
        <p class="text-sm text-gray-500 mt-1">Gerencie suas entradas</p>
      </div>
      
      <Button class="shadow-sm bg-emerald-600 hover:bg-emerald-700" @click="dialogOpen = true">
    ...
    <div v-else class="space-y-3">
        ...
        <div class="flex items-start justify-between mb-3">
          <div class="flex-1">
            ...
            <div class="flex items-center gap-2 mt-1">
              ...
              <span v-if="mov.aluno" class="flex items-center gap-1 text-xs text-emerald-600 bg-emerald-50 px-2 py-0.5 rounded-full">
      ...
      <div v-if="movimentacoes.length === 0" class="text-center py-12 bg-white rounded-xl border border-gray-100">
        ...
        <p class="text-gray-500 font-medium">Nenhuma receita cadastrada</p>
        <p class="text-sm text-gray-400 mt-1">Comece registrando sua primeira receita</p>
      </div>
    </div>
